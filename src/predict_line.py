...
if __name__ == "__main__":
    ...
    with open(r"D:\Github\Deep-Learning-Basics\OCR\Easter2-OCR-LearnAI\data\charlist") as f:
        charlist = [word.strip("\n") for word in f]
    ...
    # change the image path with the file path you want
    print(infer_obj.predict(args.path))
